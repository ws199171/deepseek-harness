...
export const en = {
  ...
  // CLI delegation (llm-cli)
  cliEditorTitle: 'CLI delegation',
  cliDetect: 'Detect installed CLIs',
  cliDetecting: 'Detecting installed CLIs…',
  cliDetectNone: 'CodeBuddy CLI is not installed. Install it and retry.',
  cliSelectHint: 'Detect a CLI, add its models, then choose one from a conversation.',
  cliAdopt: 'Add CLI models',
  cliModels: 'Available models',
  cliSelectedPath: 'Resolved executable',
  cliSelectedVersion: 'Version',
  cliSelectedHealth: 'Last probe',
  cliHealthUnknown: 'Unknown — run a probe',
  cliHealthHealthy: 'Healthy',
  cliHealthBroken: 'Broken',
  cliRunProbe: 'Run probe',
  cliProbing: 'Probing {cli}…',
  cliProbeOk: '{cli} answered the stream-json probe',
  cliProbeFail: '{cli} did not answer the probe',
  cliCommandLabel: 'Executable',
  cliArgsLabel: 'Arguments (one per line)',
  cliCwdLabel: 'Working directory',
  cliEnvLabel: 'Environment (KEY=value, one per line)',
  cliSessionIdArgLabel: 'Session-id argument',
  cliDisposeGraceLabel: 'Dispose grace (ms)',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  // CLI 委托（llm-cli）
  cliEditorTitle: 'CLI 委托',
  cliDetect: '检测已安装的 CLI',
  cliDetecting: '正在检测已安装的 CLI…',
  cliDetectNone: '未检测到 CodeBuddy CLI。请安装后重试。',
  cliSelectHint: '检测 CLI 并添加其模型，然后在对话中选择一个模型。',
  cliAdopt: '添加 CLI 模型',
  cliModels: '可用模型',
  cliSelectedPath: '解析到的可执行文件',
  cliSelectedVersion: '版本',
  cliSelectedHealth: '最近一次探活',
  cliHealthUnknown: '未知——运行探活',
  cliHealthHealthy: '健康',
  cliHealthBroken: '异常',
  cliRunProbe: '运行探活',
  cliProbing: '正在探活 {cli}…',
  cliProbeOk: '{cli} 已通过 stream-json 探活',
  cliProbeFail: '{cli} 未通过探活',
  cliCommandLabel: '可执行文件',
  cliArgsLabel: '参数（每行一个）',
  cliCwdLabel: '工作目录',
  cliEnvLabel: '环境变量（KEY=value，每行一个）',
  cliSessionIdArgLabel: '会话 ID 参数',
  cliDisposeGraceLabel: '退出宽限（毫秒）',
}

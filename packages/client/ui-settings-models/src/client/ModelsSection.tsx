...
interface ProviderEditorRenderProps extends Pick<
  ProviderEditorProps,
  'namespace' | 'schema' | 'operations' | 'cliRemote' | 't' | 'readOnly' | 'onClose'
> {
  target: EditorTarget
}
...
export function ModelsSection(props: ModelsSectionProps): ReactNode {
  const { controller, useSnapshot, operations, schema, cliRemote, t, renderSlot } = props
  if (
  ...
  return <Loaded injected={{ controller, useSnapshot, operations, schema, cliRemote: remote, t }} renderSlot={renderSlot} />
}

function Loaded({ injected, renderSlot }: { injected: ModelsSectionFace; renderSlot: ModelsRenderSlot }): ReactNode {
  const { controller, operations, schema, cliRemote, t } = injected
